...
export const accountService = {
    ...
    transferFunds: async (transferData: { sourceAccountId: string; targetAccountId: string; amount: number; description: string }): Promise<void> => {
        await apiClient.post('/api/v1/transfers', transferData);
    },
